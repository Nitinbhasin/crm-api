...
public class CRMApiController {
	...
	public ResponseEntity<Object> updateCase(@Valid @RequestBody UpdateCaseRequest updateCaseRequest, @PathVariable @NotNull String id) throws Exception {
	...
	@ApiOperation(value = "", nickname = "fetchCaseHistoryById", notes = "Fetch Case History based on CaseID", tags = { "crm", })
	...
	@ApiOperation(value = "", nickname = "fetchCaseCommentsById", notes = "Fetch Case Comments based on CaseID", tags = { "crm", })
	...
	@ApiOperation(value = "", nickname = "fetchCaseDocsByCaseId", notes = "Fetch Case Docs based on CaseID", tags = { "crm", })
	...
	@ApiOperation(value = "", nickname = "fetchCaseDocContentById", notes = "Fetch Case Doc Content based on ID", tags = { "crm", })
