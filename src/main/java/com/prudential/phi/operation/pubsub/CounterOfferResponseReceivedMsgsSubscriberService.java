...
@Component
@Slf4j
public class CounterOfferResponseReceivedMsgsSubscriberService {

	@Value("${crm.counterOfferResponseReceivedMsg.subscriptionId}")
	private String CRM_CO_RESPONSE_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_CO_RESPONSE_MSG_SUB_ID);
	}
