...
@Component
@Slf4j
public class ProposalReceivedMsgsSubscriberService {

	@Value("${crm.proposalReceivedMsg.subscriptionId}")
	private String CRM_PROPOSAL_RECEIVED_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_PROPOSAL_RECEIVED_MSG_SUB_ID);
	}
