...
@Component
@Slf4j
public class UserInfoIncomingMsgsSubscriberService {

	@Value("${crm.userInfoMsg.subscriptionId}")
	private String CRM_USERINFO_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_USERINFO_MSG_SUB_ID);
	}
