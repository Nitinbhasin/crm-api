...
@Component
@Slf4j
public class PaymentCompletionMsgsSubscriberService {

	@Value("${crm.paymentCompletionMsg.subscriptionId}")
	private String CRM_PYT_COMPLETION_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_PYT_COMPLETION_MSG_SUB_ID);
	}
