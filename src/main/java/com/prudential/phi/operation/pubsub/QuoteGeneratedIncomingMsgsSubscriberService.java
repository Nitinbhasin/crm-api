...
@Component
@Slf4j
public class QuoteGeneratedIncomingMsgsSubscriberService {

	@Value("${crm.quoteGeneratedMsg.subscriptionId}")
	private String CRM_QUOTEGENERATED_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_QUOTEGENERATED_MSG_SUB_ID);
	}
