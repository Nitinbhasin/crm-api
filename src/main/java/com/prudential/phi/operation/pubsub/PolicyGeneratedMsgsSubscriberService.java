...
@Component
@Slf4j
public class PolicyGeneratedMsgsSubscriberService {

	@Value("${crm.policyGeneratedMsg.subscriptionId}")
	private String CRM_POLICY_GENERATED_MSG_SUB_ID;
	...
	@PostConstruct
	public void init() {
		subscribeAsync(CRM_PROJECT_ID, CRM_POLICY_GENERATED_MSG_SUB_ID);
	}
